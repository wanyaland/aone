# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-10-03 01:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.CharField(choices=[(b'E', b'Event'), (b'B', b'Event')], default=b'B', max_length=20)),
                ('status', models.BooleanField(default=True)),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('modify_date', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100)),
                ('code', models.CharField(help_text='Country code ', max_length=10)),
                ('status', models.BooleanField(default=True)),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('modify_date', models.DateTimeField(auto_now=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[(b'C', b'COOL'), (b'H', b'HELPFUL'), (b'F', b'FUNNY')], max_length=20)),
        ...
        migrations.AddField(
            model_name='business',
            name='features',
            field=models.ManyToManyField(null=True, to='business.Feature'),
        ),
        migrations.AddField(
            model_name='business',
            name='owner',
